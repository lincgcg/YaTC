...
def get_args_parser():
    ...
    # theta
    parser.add_argument('--train_data_path', default='./data/ISCXVPN2016_MFR', type=str,
                        help='dataset path')
    parser.add_argument('--test_data_path', default='./data/ISCXVPN2016_MFR', type=str,
                        help='dataset path')
    return parser
...
def build_dataset(is_train, is_test , args):
    ...
    root = ''
    if is_train:
        root = os.path.join(args.train_data_path, 'train')
    elif is_test:
        root = os.path.join(args.train_data_path, 'test')
    else :
        root = os.path.join(args.test_data_path, "valid")
